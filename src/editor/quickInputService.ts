...
import { IQuickAccessController } from 'monaco-editor/esm/vs/platform/quickinput/common/quickAccess';
import { IMatch } from 'monaco-editor/esm/vs/base/common/filters';
import { ResolvedKeybinding } from 'monaco-editor/esm/vs/base/common/keybindings';
import Severity from 'monaco-editor/esm/vs/base/common/severity';
import { IMarkdownString } from 'monaco-editor/esm/vs/base/common/htmlContent';
import type {
  IDisposable,
  IEvent as Event,
  Uri as URI,
